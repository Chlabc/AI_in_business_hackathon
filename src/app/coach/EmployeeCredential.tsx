...
/**
 * HAHA front/back content and glass styling — but only ONE face is mounted
 * at a time. The CSS 3D flip (two faces in one grid cell + rotateY) mirrors
 * and composites in Chromium; a plain swap keeps the look without that bug.
 */
export function EmployeeCredential({
  ...
  return (
    <div className={colors.credential}>
      ...
      />
      <div className={colors.credentialRotor}>
        {!flipped ? (
          <div
            id={frontId}
